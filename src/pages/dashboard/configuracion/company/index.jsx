...
import { PhoneNumberMaskInput } from '../../../../utils/maskFormat';
// layouts
...
export default function CompanyPage() {
  ...
  return (
    <Page title={`Compañía | ${config.nameApp}`}>
      <Container>
        <HeaderDashboard
          heading="Compañía"
                    ...
                    <Grid container spacing={2}>
                      ...
                      <Grid item xs={12} md={6}>
                        ...
                        <TextField
                          ...
                          InputProps={{ inputComponent: PhoneNumberMaskInput }}
